...
export class VietQR {
    ...
    async genQRCodeBase64({ bank = '', accountName = '', accountNumber = '', amount = '', memo = '', template = 'qr_only' }) {
        if (this.checkKey()) {
    ...
    async genQRCodeBase64V1({ bank = '', accountName = '', accountNumber = '', amount = '', memo = '', format = 'qr_only' }) {
        if (this.checkKey()) {
    ...
    genQuickLink({ bank = '', accountName = '', accountNumber = '', amount = '', memo = '', template = 'qr_only', media = '' }) {
        if (this.checkKey()) {
            let url =
                media == '.jpg'
    ...
    async createPaymentGateway({ theme_slug, platform = '', bankId = '', accountName = '', accountNumber = '', addInfo = '', amount = '' }) {
        if (this.checkKey()) {
            let entity = {
